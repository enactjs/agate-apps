  ...
  handlers: {
    layoutArrangeableToggle: (ev, { updateAppState }) => {
      updateAppState(state => {
        state.userSettings.arrangements.arrangeable = !state.userSettings
          .arrangements.arrangeable;
      });
    },
    ...
    return (
      <div {...rest}>
          ...
          <afterTabs>
            ...
            >
              ...
              <Cell shrink className={css.buttons}>
                <Row
                  align={
                    copperSkinFamily ? "center start" : "center space-around"
                  }
                >
                  <Cell shrink>
        ...
        <Popup onClose={onTogglePopup} open={showPopup} closeButton>
          ...
          This is an example of a popup with a body section and a title. Plus
          there&apos;re buttons!
          <buttons>
  ...
  return class extends React.Component {
    ...
    onSelect = handle(
      adaptEvent(ev => {
        ...
        this.setState(state =>
          state.index === index ? null : { prevIndex: state.index, index }
        );
        return { index };
      }, forward("onSelect"))
    ).bind(this);
