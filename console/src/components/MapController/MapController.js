            ...
            <Column className={css.toolsColumn}>
              ...
              {autonomousSelection && !(destination && navigating) ? (
                <Cell shrink={locationSelection} className={css.columnCell}>
                  <Heading spacing="medium" className={css.heading}>
                    Self-driving
                  </Heading>
                  <Row
                    component={Group}
              ...
              {destination && (
                <Cell shrink className={css.columnCell + " " + css.travelInfo}>
                  <p>
                    {formatDuration(navigation.duration, durationIncrements)
                      .split(" ")
                      .map(
                        ...
                        (str, index) =>
                          isNaN(parseInt(str)) ? (
                            ...
                            <span className={css.number} key={"number" + index}>
                              {str}
                            </span>
                          )
                      )}
                  ...
                  <p>
                    {(navigation.distance / 1609.344).toFixed(1)} mi -{" "}
                    {formatTime(navigation.eta)}
                  </p>
                </Cell>
              )}
